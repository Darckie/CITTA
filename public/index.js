...
// // msgx.textContent = "We use cookied for improved functionality and analytics";

// msgx.innerHTML =
//   'We use cookied for improved functionality and analytics.<i href=#><button class="btn">Got it!</button></i>';
// nav.prepend(msgx);

// msgx.addEventListener("click", function () {
//   msgx.display = this.hidden;
// });
